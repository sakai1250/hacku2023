...
//            TutorialPage(imageName: "Tutrial4"),
            TutorialPage(imageName: "Tutrial0", description:"こんにちは村田です"),
            TutorialPage(imageName: "Tutrial1", description:"今日はMambaを説明します"),
            TutorialPage(imageName: "Tutrial2", description: "これは素晴らしいです"),
            TutorialPage(imageName:"Tutrial3",description:"ここまでで質問のある方はいますでしょうか"),
            TutorialPage(imageName: "Tutrial4", description: "これでMambaの説明を終わります。"),
        ]
    }
